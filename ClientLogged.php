...
<nav class="navbar navbar-expand-md bg-dark navbar-dark">
    ...
    <div class="collapse navbar-collapse" id="collapsibleNavbar">
        ...
        <ul class="nav nav-pills" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="pill" href="#menu1">Make a new ask</a>
            </li>
            <li class="nav-item">
                <a class="nav-link " data-toggle="pill" href="#request">your ask</a>
            </li>
            <li class="nav-item">
...
<div class="tab-content">
    <div  id="menu1" class="container tab-pane active">
        <h3 class="text-center text-dark"> מאגר משתמשים במערכת לאישור בקשות לטיסה בטחונית חריגה  </h3>
            <div class="col-md-4">
                <h3 class="text-center text-info">  Make a new request </h3>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalLong">Make Ask</button>
            </div>
        ...
        <div id="request" class="container tab-pane fade"><br>
            ...
            <div class="row justify-content-right" >
                <div class="col-md-8 "  >
                    ...
                    $query="SELECT * FROM request WHERE CLIENTID=?";
                    $stmt =$conn->prepare($query);
                    $stmt->execute([intval($user->getID())]);
